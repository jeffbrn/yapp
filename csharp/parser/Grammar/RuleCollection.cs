...
namespace Yapp.Parser.Grammar {
	/// <summary>
	/// A collection of rules that will make up a grammar. The collection is defined by creating with a start rule
	/// and then rules are added until the grammar is complete.
